// Failas: js/logger.js (Pilna, veikianti modulinė versija)
(function() {
    'use strict';
    ...
    // Padarome lentelės perkrovimo funkciją pasiekiamą globaliai, kad auth.js galėtų ją kviesti
    window.appActions.loadAndRenderLogTable = loadAndRenderLogTable;
    window.appActions.renderLogTable = renderLogTable; // Reikalinga atsijungimui
